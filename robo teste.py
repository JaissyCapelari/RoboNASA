...
titulo = tk.Label(root, text="Agência Espacial - Robôs Inteligentes", font=("Arial", 12, "bold"))
titulo.pack(pady=10)

btn1 = tk.Button(root, text="1 - Cadastrar robô", width=30, command=cadastrar_robo)
btn1.pack(pady=5)

btn2 = tk.Button(root, text="2 - Listar robôs", width=30, command=listar_robos)
btn2.pack(pady=5)

btn3 = tk.Button(root, text="3 - Simular missão", width=30, command=simular_missao)
btn3.pack(pady=5)

btn4 = tk.Button(root, text="4 - Mostrar campo de missão", width=30, command=mostrar_campo)
btn4.pack(pady=5)

btn5 = tk.Button(root, text="5 - Recuperar robô", width=30, command=recuperar_robo)
btn5.pack(pady=5)

btn6 = tk.Button(root, text="6 - Sair", width=30, command=root.quit)
btn6.pack(pady=20)
